...
Created developer-facing content for voice AI (Alexa) and cloud services (AWS). Worked across teams to ensure consistency and clarity in documentation that reached millions of developers worldwide.
...
Early career foundation in technical writing, learning to navigate large-scale documentation systems and cross-functional collaboration in an enterprise environment.
